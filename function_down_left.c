...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   function_down_right.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ikryvenk <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/03 16:23:08 by ikryvenk          #+#    #+#             */
/*   Updated: 2017/03/03 16:24:05 by ikryvenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	mission_complete_1(t_flist *lst)
{
	...
	while (x != lst->height)
	{
		if (lst->map[x][lst->y[1]] == 2 ||
			lst->map[x][lst->y[1]] == 1 ||
			lst->map[x][lst->y[1] - 1] == 2 ||
			lst->map[x][lst->y[1] - 1] == 1)
			return (1);
		x++;
	}
	return (0);
...
static int	mission_complete_0(t_flist *lst)
{
	...
	while (y != lst->width)
	{
		if (lst->map[lst->x[0]][y] == 2 ||
			lst->map[lst->x[0]][y] == 1 ||
			lst->map[lst->x[0] + 1][y] == 2 ||
			lst->map[lst->x[0] + 1][y] == 1)
			return (1);
		y++;
	}
	return (0);
