...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   function_top_right.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ikryvenk <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/03 16:18:40 by ikryvenk          #+#    #+#             */
/*   Updated: 2017/03/03 16:22:05 by ikryvenk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	mission_complete_0(t_flist *lst)
{
	...
	while (x != lst->height)
	{
		if (lst->map[x][lst->y[0] - 1] == 2 ||
			lst->map[x][lst->y[0] - 1] == 1 ||
			lst->map[x][lst->y[0] - 2] == 2 ||
			lst->map[x][lst->y[0] - 2] == 1)
			return (1);
		x++;
	}
	return (0);
